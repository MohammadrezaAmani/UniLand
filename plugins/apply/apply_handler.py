...
@Client.on_message(filters.regex(messages.APPLY))
async def apply_handler(client:pyrogram.client.Client, message:pyrogram.types.messages_and_media.message.Message):
