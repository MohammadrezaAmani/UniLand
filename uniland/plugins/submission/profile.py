...
async def update_profile_title(client, message,):
...
@Client.on_message(user_step(UserSteps.PROFILE_SUBMISSION_PHONE.value)
                   & ~filters.me & filters.text & ~exact_match(Triggers.BACK.value))
async def profile_phone(client, message,):
...
@Client.on_message(user_step(UserSteps.PROFILE_SUBMISSION_EMAIL.value)
                   & ~filters.me & filters.text & ~exact_match(Triggers.BACK.value))
async def profile_email(client, message,):
...
@Client.on_message(user_step(UserSteps.PROFILE_SUBMISSION_UNIVERSITY.value)
                   & ~filters.me & filters.text & ~exact_match(Triggers.BACK.value))
async def profile_university(client, message,):
...
@Client.on_message(user_step(UserSteps.PROFILE_SUBMISSION_FACULTY.value)
                   & ~filters.me & filters.text & ~exact_match(Triggers.BACK.value))
async def profile_faculty(client, message,):
...
@Client.on_message(user_step(UserSteps.PROFILE_SUBMISSION_OWNER_TITLE.value)
                   & ~filters.me & filters.text & ~exact_match(Triggers.BACK.value))
async def profile_owner_title(client, message,):
...
@Client.on_message(user_step(UserSteps.PROFILE_SUBMISSION_DESCRIPTION.value)
                   & ~filters.me & filters.text & ~exact_match(Triggers.BACK.value))
async def profile_description(client, message,):
