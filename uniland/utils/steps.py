...
class UserSteps(enum.Enum):
  ...
  EDIT_DOCUMENT_SUBMISSION_OWNER_TITLE = 'EDIT_DOCUMENT_SUBMISSION_OWNER_TITLE'.lower(
  )
  EDIT_DOCUMENT_SUBMISSION_DESCRIPTION = 'EDIT_DOCUMENT_SUBMISSION_DESCRIPTION'.lower(
  )
  ...
  EDIT_DOCUMENT_SUBMISSION_SEMESTER_YEAR = 'EDIT_DOCUMENT_SUBMISSION_SEMESTER_YEAR'.lower(
  )
